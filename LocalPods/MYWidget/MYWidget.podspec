#
#  Be sure to run `pod spec lint MYWidget.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "MYWidget"
  s.version      = "0.0.1"
  s.summary      = "xiaplay的组件."

  s.description  = <<-DESC
                   A longer description of MYWidget in Markdown format.
  ...
  s.homepage     = "http://gitlab.alibaba-inc.com/xiaplay-core/MYWidget"
  ...
  s.source       = { :git => "http://gitlab.alibaba-inc.com/xiaplay-core/MYWidget.gitw", :tag => "0.0.1" }
