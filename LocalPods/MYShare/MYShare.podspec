#
#  Be sure to run `pod spec lint MYShare.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "MYShare"
  s.version      = "0.0.1"
  s.summary      = "A short description of MYShare."
  ...
  s.homepage     = "http://EXAMPLE/MYShare"
  ...
  s.source       = { :git => "http://wmy.com/MYShare.git", :tag => "#{s.version}" }
