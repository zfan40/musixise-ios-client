...
- (void)viewWillLayoutSubviews {
    ...
    _tableView.frame = CGRectMake(0, _showSubHeadView ? _subHeadView.bottom : _headView.bottom, self.view.width,
                                  self.view.height - (_showSubHeadView ? _subHeadView.bottom : _headView.bottom));
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        cell = [[TTDealTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault
