...
- (void)setModel:(TTDealItemModel *)model {
    ...
    [attribute setAttributes:@{
        NSForegroundColorAttributeName: RGB(94, 94, 95)
    }
                       range:NSMakeRange(money.length - 2, 2)];
    [attribute setAttributes:@{
        NSForegroundColorAttributeName: RGB(193, 46, 54)
    }
                       range:NSMakeRange(0, money.length - 2)];
