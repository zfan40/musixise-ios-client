...
- (void)setReturnButtonIndex:(NSInteger)returnButtonIndex {
    objc_setAssociatedObject(self, &kTTActionSheetBUTTONINDEX_IDENTIFER, [NSNumber numberWithInteger:returnButtonIndex],
    ...
    if (NSClassFromString(@"UIAlertController")) {
        ...
        if (destructiveButtonTitle) {
            UIAlertAction *confirm =
                [UIAlertAction actionWithTitle:destructiveButtonTitle
        ...
        TTActionSheet *alert = [TTActionSheet actionSheetWithTitle:title
                                                           subview:subview
                                                 cancelButtonTitle:cancelButtonTitle
                                            destructiveButtonTitle:destructiveButtonTitle
