...
- (void)layoutSubviews {
    ...
    _photoButton.frame =
        CGRectMake((self.width - photoButtonSize.width) / 2.0,
                   (self.height - _headView.height - _postButton.height - photoButtonSize.height) / 2 + 25,
                   photoButtonSize.width, photoButtonSize.height);
