...
- (void)layoutSubviews {
    ...
    CGFloat margin = 25;
    CGFloat titleW = [_titelLab.text boundingRectWithSize:CGSizeMake(INT16_MAX, self.height)
                                                  options:NSStringDrawingUsesFontLeading
                                               attributes:@{
                                                   NSFontAttributeName: _titelLab.font
                                               }
                                                  context:nil]
                         .size.width;
    ...
    _indicatorImageview.frame =
        CGRectMake(self.width - indicatorImageSize.width - 20, (self.height - indicatorImageSize.height) / 2.0,
