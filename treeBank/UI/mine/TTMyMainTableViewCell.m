...
-(void)layoutSubviews{
    ...
    _logoImageView.frame = CGRectMake( margin, (size.height-imageSize.height)/2.0, imageSize.width, imageSize.height);
    ...
    _indicatorImageview.frame = CGRectMake( size.width-margin-indicatorImageSize.width, (size.height-indicatorImageSize.height)/2.0, indicatorImageSize.width, indicatorImageSize.height);
