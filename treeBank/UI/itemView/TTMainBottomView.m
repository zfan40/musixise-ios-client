...
-(void)updateButton:(TTMainButton*)button selected:(BOOL)selected{
    ...
    if(button==_mainButton ){
        _mainButton.mainImageView.image = selected?[UIImage imageNamed:@"myMainSelected"]:[UIImage imageNamed:@"myMain"];
        _mainButton.label.textColor = selected?hightlightColor:normalColor;
        selected = NO;
        _mineButton.mainImageView.image = selected?[UIImage imageNamed:@"myCountSelected"]:[UIImage imageNamed:@"myCount"];
        _mineButton.label.textColor = selected?hightlightColor:normalColor;

        _businessButton.mainImageView.image = selected?[UIImage imageNamed:@"dealProgressSelected"]:[UIImage imageNamed:@"dealProgress"];
