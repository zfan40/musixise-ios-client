...
- (void)handlePanGesture:(UIPanGestureRecognizer *)panGestureRecognizer {
    ...
    BOOL positiveDirection = self.reverseGestureDirection ? ![self isGesturePositive:panGestureRecognizer]
                                                          : [self isGesturePositive:panGestureRecognizer];

    switch (panGestureRecognizer.state) {
        case UIGestureRecognizerStateBegan:
            if (positiveDirection) {
                if (self.nextViewControllerDelegate &&
                    [self.nextViewControllerDelegate
                        conformsToProtocol:@protocol(TTTransitionInteractionControllerDelegate)]) {
